...
Section check.
  ...
  *)
  ...
  Lemma det_tree_det_tree_seq sP L:
  ...
  Lemma step_next_alt_failed {sP A B C s b}:
    check_program sP ->
      det_tree sP A -> step u p s A = (Failure, B) ->
  ...
  Section tail_cut.
    ...
    Lemma tail_cut_is_det sP t:
      AllTailCut -> tm_is_det sP t -> is_det (TA (call t)).
    Proof.
