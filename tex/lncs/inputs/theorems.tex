...
\end{array}
$$
Partial applications like \elpiIn{once likes} in the introduction
require the following extra rules:
$$
\arraycolsep=1.4pt
\begin{array}{rl}
...
\checkc\ to preserve the invariant.\marginpar{right}
...
\begin{proof}
  \textcolor{red}{
    Without loss of generality, we let $r = \clauseCmd{p}{\vecL{t}}{bs}$ for
    a given predicate $p$, a list of terms $t$ and a list of premises $bs$.
    By definition of \checkc, we have the hypothesis $p \vecL{t}$ is 
  }
\end{proof}
