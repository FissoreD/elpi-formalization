...
mixed, and prop stuff is executable.
...
type app tm -> tm -> tm.
type lam (tm -> tm) -> tm.
type con string -> tm. % necessaria senno la whd inizia sempre per lam
...
of (con "0") nat.
of (con "1") nat.
of (con "plus") (arr nat (arr nat nat)).
\end{elpicode}

Note ! makes whd a function.
