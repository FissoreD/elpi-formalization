...
\title[Determinacy Checking for Elpi]{Determinacy Checking for Elpi: an Higher-Order Logic Programming language with Cut}
...
\keywords{Functionality, Determinacy Analysis, Higher Order, Logic Programming, Cut
}
...
\begin{acks}
This work has been supported by the French government, through the France 2030
