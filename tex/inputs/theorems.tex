...
called \emph{semidet} in \cite{1996henderson}, or
...
especially when they instrument their code for debugging: a
we believe our static check of observational determinacy can mitigate that. 
