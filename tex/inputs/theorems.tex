...
if \elpiIn{mem} is a function in our sense.
In this case the code of \elpiIn{silly} is operationally
equivalent to the following, cluttered, one where the worst-case complexity is clearly
the sum of its parts (and not its product).
