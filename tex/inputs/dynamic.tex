...
of free variables occurring in $t$. When $\vars\ t = \EmptyList$ we say that
$t$ is \ground.
...
\newcommand{\runFig}{
  ...
  \bigg[
    ...
    %\Big(
    %\underbrace{
      \big(\big[(\prog, g, a) \mid g \in \vecL{g}\big] @\ \vecL{g}\big)
    %}_{\mathrm{premises}} @ ~ \vecL{g}
...
% introduced.
  ...
  %   \underbrace{\big[(\prog, g, a) \mid g \in \vecL{g}\big]}_{\mathrm{premises}} @ ~ \vecL{g}
  %   %\Big)
  %   %\bigg)
  %   ~\bigg\rvert~
