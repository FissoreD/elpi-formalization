...
with two outputs of the same type $A$.
...
$t[x/y]$ for the usual, capture avoiding, operation or replacing the variable $y$
with $x$ inside $t$.
...
and $\subst[']$ is the most general extension of $\subst$
...
and $(x,h) + \prog$ to add
the name $x$ to $\aleph$ and the extra clause $h$ to $\mathcal{I}$.
