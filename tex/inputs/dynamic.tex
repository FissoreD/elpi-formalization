...
unification variables and small letters for bound variables.\todo{mi serve un NT = $\X \mid P $}

The programmer provides a context \ctx{} that assigns a
signature $sig$ to each predicate. By convention predicates take
...
a single node \texttt{exp}.\todo{what about \V?}
