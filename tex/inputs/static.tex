...
%  and also avoid code duplication\footnote{require multiple copies of the same code just because they differ in signature}.


The \mySub\ relation extend the intuitive inclusion of mathematical functions
...
% The definition of \mySub\  type checking as in~\cite{1992nadathur}:
...
are compared in a contravariant way. The intuition is that the meaning of a 
...
The relation \mySub\ is such that $f_1 \mySub f_2 = \sem{f_1} \Rightarrow \sem{f_2}$,
