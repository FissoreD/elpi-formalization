...
arguments. Inference is applied to atoms in negative positions -- i.e., atoms
that are interpreted. To align with our definition of determinacy, we must
verify that the inferred determinacy of their \textit{inputs} is at most \mySub,
wrt their expected signature.  

Regarding the \textit{outputs} of clauses, and since these \textit{outputs} can
be interpreted as new atoms in the code, we need to ensure that their inferred
