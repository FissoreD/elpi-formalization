...
as \( g \) they are parameterized by determinacy $d$ (either \detI or \relI) --
\detI is used for \minT and \relI for \maxT. We note $\overline{d}$ to denote
the negation of $d$, switching its determinacy value. The definition of these
...
\begin{equation}
  ...
  \begin{cases}
    ...
    \ \dtype{d}{(\map\ g_{\overline{d}}\ \vecL{ac})}{(\map\ f_d\ \vecL{bd})} & \text{if } s_k = \dtype{\relI}{\vec a}{\vec b}\ \land\ s_{3-k} = \dtype{\detI}{\vec c}{\vec d} \\
    %\ \dtype{D}{(\vecL{g\ a\ c})}{(\vecL{f\ b\ d})}     & \text{if } s_1 = \dtype{D}{a}{b}\ \land\ s_2 = \dtype{D}{c}{d}             \\
    \ \dtype{\func}{(\map\ g_{\overline{d}}\ \vecL{ac})}{(\map\ f_d\ \vecL{bd})}     & \text{if } s_1 = \dtype{\func}{\vec a}{\vec b}\ \land\ s_2 = \dtype{\func}{\vec c}{\vec d}             \\
