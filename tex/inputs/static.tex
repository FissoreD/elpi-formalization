...
The static checker performs a form of dataflow analysis by
storing in the context \ctx the signature of each variable
and updating it as it traverses the body of a clause.
