...
preconditions (i.e. if it is possible to infer the input argument to have a
determinacy \mySub wrt the expected signature) and if they are satisfied
assuming new knowledge for the postconditions (i.e. are assumed
to have the expected determinacy). The \checkc\ procedure verifies
