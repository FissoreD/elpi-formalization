...
These updates use the ``dual'' operators \minT\ and \maxT.
In their mutual definition below we denote one of them
with $f$ and $g$ the other one:
...
\newcommand{\maximize}{\texttt{weaken}\xspace}
\newcommand{\minimize}{\texttt{strenghten}\xspace}
