...
For example, consider the term \elpiIn{(once likes)} from the
introduction has an inferred signature \elpiIn{func guest -> dish}
given \elpiIn{func once (pred i:A, o:B), A -> B}.
