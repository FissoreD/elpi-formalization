...
predicates that are \textit{wrongly} called.
...
\begin{equation}
  ...
  \begin{cases}
    ...
    (\forall i, c_i \mySub a_i) \land (\forall j, b_j \mySub d_j) & \text{if } f_1 = \dtype{\func}{a}{b} \land f_2 = \dtype{\func}{c}{d}     \\
    (\forall i, c_i \mySub a_i) \land (\forall j, b_j \mySub d_j) & \text{if } f_1 = \dtype{\detI}{a}{b} \land f_2 = \dtype{\relI}{c}{d}     \\
