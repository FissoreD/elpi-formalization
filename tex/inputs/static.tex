...
\noindent \elpiIn{compose} has the classical mathematical definition. In the
program we implement an optimization for composition of the higher-order
functions under the \elpiIn{map} predicate.

Considering the rule at line 30, \checkc
assumes that the clause is called with the correct arguments. Therefore,
