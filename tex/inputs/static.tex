...
are transformed to clauses that must be validated by the \checkc\ routine. In this\todo{split \ref{rule:infer-lam}}
...
tries to prove, in the sense of~\cref{def:sem} the determinacy
of an atom by checkig the pre-conditions and deducing new
