...
The rules for \run{} are given in~\cref{fig:basic-interp} where
...
\begin{definition}[Mutually-exclusive heads (\mutExclHeads)]
  ...
  Let $\ctx\ \pred = \dtype{\pred}{i_1 \ldots i_k}{\_}$
  \begin{align*}
...
its discriminating argument $d$ to be ground. The reasoning goes as follows.
