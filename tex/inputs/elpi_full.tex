...
\begin{theorem}[Determinacy checking property]
  ...
  \begin{align*}
    &\detCheck\ \prog\ \to \\ 
      &\quad(\forall p\ c, c \in \prog\ p \to \checkc\ \ctx\ c) \to \\
        &\qquad \isdet\ \prog\ \pred\ i\ o \land \infer\ o = \get{o}p
  \end{align*}
  \vspace{-20pt}
  \label{th:det3}
\end{theorem}
