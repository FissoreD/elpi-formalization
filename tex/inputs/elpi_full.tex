...
static checker. \ctx\ stands for a context and is a mapping from variable and
predicate names to their determinacy signature. Variables signatures are added
during the checking operation.
The entry point of the checker is \ref{rule:check-clause}.


TODO: check\_clause in \ref{rule:check-ho} does not work if the head is a var,
we should perform a deref of $\ctx$
