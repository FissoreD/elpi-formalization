...
\begin{equation}
  \minT\ f_1 f_2 =
  \begin{cases}
    \dtype{\detI}{(\overrightarrow{\maxT}\ a\ c)}{(\overrightarrow{\minT}\ b\ d)} & \text{if } f_k = \dtype{\relI}{a}{b} \land f_{2-k} = \dtype{\detI}{c}{d}\\
    \dtype{D}{(\overrightarrow{\maxT}\ a\ c)}{(\overrightarrow{\minT}\ b\ d)}     & \text{if } f_1 = \dtype{D}{a}{b} \land f_2 = \dtype{D}{c}{d}             \\
...
\begin{equation}
  \maxT\ f_1 f_2 =
  \begin{cases}
    \dtype{\detI}{(\overrightarrow{\minT}\ a\ c)}{(\overrightarrow{\maxT}\ b\ d)} & \text{if } f_k = \dtype{\relI}{a}{b} \land f_{2-k} = \dtype{\detI}{c}{d} \\
    \dtype{D}{(\overrightarrow{\minT}\ a\ c)}{(\overrightarrow{\maxT}\ b\ d)}     & \text{if } f_1 = \dtype{D}{a}{b} \land f_2 = \dtype{D}{c}{d}             \\
