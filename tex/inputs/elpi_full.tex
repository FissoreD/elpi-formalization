...
%
\begin{align}
  ty   & ::= data \mid pred                                    \label{eq:ty1}        \\
  data & ::= \texttt{c}\ data^\ast \mid data \to data \mid \predVar \label{eq:data1} \\
...
with their determinacy. Labels are instances of $ty$ in \cref{eq:ty1}, to
simplify our presentation, $data$s in \cref{eq:data1} are represented with the
\expI\ tag.
