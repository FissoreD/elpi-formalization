...
%  in order to lower the cost of mechanization.
...
\noindent The first implementation given at line 6 is accepted since \elpiIn{likes!} is a
...
The third one, at line 8, is rejected since it miscalls \elpiIn{map} without
compensating for it.
...
\noindent In line 5 the output of \elpiIn{commit} is a function \elpiIn{F} that
...
is. The example at line 7 is rejected since \elpiIn{id} is miscalled: the outputs
...
code is at line 6 where we cross the binder in \elpiIn{F} by performing two
operations:
