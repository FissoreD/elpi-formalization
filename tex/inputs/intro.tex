...
\elpiIn{func map (func A -> B), list A -> list B.}
...
first two validate this one: \elpiIn{func meal list guest -> list dish}.
...
Our contributions are a det check that:
\begin{itemize}
\item covers covers higher order logic programming constructs such as first class predicates and clauses
